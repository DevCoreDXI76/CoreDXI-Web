  ...
  return (
    <li className="space-y-0.5">
      ...
      <div className="flex items-start gap-2">
        <code className="block flex-1 break-all rounded bg-white/80 px-2 py-1 text-[11px] text-amber-950">
          {value}
        </code>
        <button
          type="button"
          className="shrink-0 rounded border border-amber-300 bg-white px-2 py-1 text-[11px] font-medium hover:bg-amber-100"
          onClick={() => {
...
export function OAuthRedirectHelp({
  ...
  return (
    <div className="w-full space-y-2 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-left text-xs text-amber-900">
